...
import { MdClose, MdDashboard, MdEventAvailable, MdMenu, MdSettingsSuggest } from 'react-icons/md'
...
const AdminPanelContent = () => {
	...
	const menuItems = [
		...
		{ label: 'Rezerwacje', icon: <MdEventAvailable size={18} />, key: 'reservations' },
