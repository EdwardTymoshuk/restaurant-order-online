...
export default function CheckoutPage() {
	...
	const [deliveryCoordinates, setDeliveryCoordinates] = useState<Coordinates | null>(
		null
	)
							...
							<div className="space-y-4">
								...
								{state.totalAmount < MIN_ORDER_AMOUNT && (
									<div className="mt-4 p-2 bg-warning-light text-warning text-center rounded-md">
										Brakuje jeszcze {amountNeeded.toFixed(2)} zł do minimalnej kwoty
										zamówienia, która wynosi 50 zł.
									</div>
								)}
						...
						<div className="flex flex-col space-y-1">
							<div className="flex items-start space-x-2">
								...
								>
									...
									i wyrażam zgodę na przetwarzanie moich danych w celu realizacji
									zamówienia.
								</label>
							</div>
							{privacyError && (
